...
const MobileMenu = ({menu}) => {
    ...
    return (
        <div className="flex items-center md:hidden">
          <a className="mr-4" href="http://elyexoticsecommerce.local/my-account/">
          ...
          <a href="http://elyexoticsecommerce.local/cart/" className="mr-2 relative menu__cart-button cursor-pointer">
