        ...
        <nav className={`${menuClasses} hidden md:flex md:items-center z-10 relative flex-1`}>
            ...
            {shop && 
              <div className="flex items-center">
                <a className="md:mr-4 lg:mr-8" href="http://elyexoticsecommerce.local/my-account/">
                ...
                <a href="http://elyexoticsecommerce.local/cart/" className="relative menu__cart-button cursor-pointer">
