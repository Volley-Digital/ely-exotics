    ...
    return (
        <div style={{backgroundColor: `#${bgColour}`}} className={`relative ${marginBottom && 'mb-10 md:mb-16 lg:mb-20'}`}>
            <section className="max-w-screen-2xl mx-auto px-6 md:px-8 py-10 md:py-32 lg:py-40">
                ...
                <form className="md:bg-white-0 relative z-10 md:flex flex-wrap justify-between max-w-2xl lg:max-w-3xl md:shadow-2xl">
                    ...
                    <div className="relative bg-white-0 py-6 pl-8 pr-6 md:px-6 md:flex items-center">
                        ...
                        <label className="md:flex items-center block mb-4 md:mb-0">
                            ...
                            <input type="text" className="outline-none w-full md:w-32 lg:w-40 border-b border-black-0 pb-2 lg:text-lg md:mx-4" onChange={(e) => setNameValue(e.target.value)} value={nameValue} placeholder="Name (Optional)" />
                        </label>
                        <input type="email" required className="outline-none border-b w-full md:w-32 lg:w-40 border-black-0 pb-2 lg:text-lg md:mx-4 mb-2 md:mb-0" onChange={(e) => setEmailValue(e.target.value)} value={emailValue} placeholder="Email (Required)" />
                    </div>
                    <div className="bg-gradient-to-b from-primary-light to-primary-dark flex justify-center items-center py-4 md:py-0 px-8 cursor-pointer w-32 ml-auto duration-300 transform hover:-translate-y-2 hover:translate-x-2 hover:shadow-lg">
