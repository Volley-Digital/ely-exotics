        ...
        <form className="py-10 bg-black-default" data-netlify="true" action="/" name="contact-form" method="post" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-wrap px-4 md:px-5">
                <div className="w-full md:w-1/2 px-2 md:px-3 mb-4 md:mb-6">
                    <input onChange={handleInputChange} value={inputs.name} className="w-full bg-white-0 px-4 py-3 outline-none" required type="text" name="name" placeholder="name" />
                </div>
                <div className="w-full md:w-1/2 px-2 md:px-3 mb-4 md:mb-6">
                    <input onChange={handleInputChange} value={inputs.email} className="w-full bg-white-0 px-4 py-3 outline-none" required type="email" name="email" placeholder="email" />
                </div>
                <div className="w-full md:w-1/2 px-2 md:px-3 mb-4 md:mb-6">
                    <input onChange={handleInputChange} value={inputs.subject} className="w-full bg-white-0 px-4 py-3 outline-none" required type="text" name="subject" placeholder="subject" />
                </div>
                <div className="w-full md:w-1/2 px-2 md:px-3 mb-4 md:mb-6">
                ...
                <div className="w-full px-2 md:px-3 mb-4 md:mb-6">
                    <textarea onChange={handleInputChange} value={inputs.message} className="w-full bg-white-0 px-4 py-3 outline-none" required type="text" name="message" rows="8" placeholder="additional information" />
                </div>
            </div>
