...
const TitleImageBanner = ({title, image, subTitle, stars, parent, overlay, website}) => (
    <section className="mb-10 md:mb-6">
        <div className="bg-white-100 mb-10 md:mb-16">
        <Img 
            Tag="div"
            fluid={image}
            className={`title-banner-image mx-auto`}
        />
        </div>
...
export default TitleImageBanner;